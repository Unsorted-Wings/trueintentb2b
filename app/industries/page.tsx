    ...
    <>
      ...
      <section className="relative overflow-hidden bg-navy-950 bg-grid-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-44">
          <Reveal>
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-accent-yellow">Industries</p>
            <h1 className="mt-5 max-w-4xl font-display text-4xl font-bold leading-tight tracking-tight md:text-6xl">
              ...
              <span className="text-brand-400">language.</span>
            </h1>
            ...
            {industries.map((ind, i) => (
              <Reveal key={ind.name} delay={(i % 3) * 0.08}>
                <article className="group relative flex h-full flex-col overflow-hidden border border-navy-100 bg-navy-50/50 p-8 transition duration-300 hover:-translate-y-1.5 hover:border-brand-200 hover:bg-white hover:shadow-xl hover:shadow-brand-500/10">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-navy-600">{ind.blurb}</p>
                </article>
              </Reveal>
            ))}
          </div>
